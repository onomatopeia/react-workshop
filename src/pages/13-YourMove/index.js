  ...
  <div>
    ...
    <ul>
      <li>
        ...
        start at 140 and decrements as you type in. It should keep running
        below 0, like on Twitter.
      </li>
      <li>
    ...
    <ul>
      <li>
        The button has specific styles when disabled.
      </li>
      <li>
        The textarea and the counter have specific styles when reading below 0.
      </li>
    </ul>
    ...
    <p>
      ...
      sender work! To save you from the boilerplate, we create a Redux store, an
      empty reducer, an empty action and connected everything for you. Feel free
      to have a look at the code in the current folder before jumping in.
    </p>

    <ul>
      <li>
        In <code>actions.js</code>, there is an empty <code>addMessage</code> action
      ...
      <li>
        In <code>components/Form.js</code>, you need to make your button fire your
        dispatched action.
      </li>
    </ul>
