...
const Page = (props) => (
  <div>
    ...
    <p>
      If you didn’t tackle the <Link to='/WrappingUp'>MessageBoard exercice</Link>,
      give it a try on your own. If you don’t feel like learning Redux right now,
      that’s also fine. Find an exercice you’d like to iterate on, and keep adding
      features and refinements to it.
    </p>
    ...
    <p>
      It is a great tool to kickstart a React application without struggling with
      any sort of configuration. Just install the command line utility globally
...
$ create-react-app my-project`}</Code>
    ...
    <Code>{`$ npm install next --save
$ ./node_modules/.bin/next`}</Code>

    <SectionTitle text='Build some cool shit' />

    <p>
      Find a little project that you would like to build and get started! Come
      up with an idea that is simple enough so you can easily get a <abbr title='Minimum Viable Product'>
      MVP</abbr> running but extensible enough so you don’t get bored too quickly.
    </p>
